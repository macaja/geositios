        ...
        switch (accion){
        	case ("nombre"):
        		...
        		try{
    				...
    				request.setAttribute("busqueda","Por Nombre>>"+nombre);
        	...
        	case ("tipos"):
        		...
        		try{
        			...
        			if(lugares.isEmpty()){
    					...
    					request.setAttribute("busqueda","Categoria>>"+categoria);
    				request.setAttribute("lugares", lugares);
    				javax.servlet.RequestDispatcher rd = request.getRequestDispatcher("mostrar.jsp");
    	    		rd.forward(request, response);
    				}
			...
			try {
				...
				request.setAttribute("lugares", lugares);
				javax.servlet.RequestDispatcher rd = request.getRequestDispatcher("usuario.jsp?msg=El lugar ahora se encuentra en su lista de favoritos");
	    		rd.forward(request, response);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			...
			try {
				...
				request.setAttribute("lugares", lugares);
				javax.servlet.RequestDispatcher rd = request.getRequestDispatcher("usuario.jsp?msg=El lugar se ha eliminado de tu lista de favoritos");
	    		rd.forward(request, response);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
