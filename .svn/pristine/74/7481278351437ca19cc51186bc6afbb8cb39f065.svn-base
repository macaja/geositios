...
<body class="cuerpo">
<div id="salir">
<form method="post" action="/Jacam/enlace">    
    <input type="submit" name="ok" value="Salir" class="button salir">
</form>
</div>
<section id="ban2">
<h1>Consulta</h1>
<h3 ><a href="/Jacam/usuario.jsp">Busqueda de Lugares</a>>><%=request.getAttribute("busqueda") %></h3>
...
function initMap() {
    ...
    <script async defer
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBRHzn9G_iNQggnEwwM_m7QCZiAH0C7S8U&libraries=places&callback=initMap">
    </script>
</body>
</html>